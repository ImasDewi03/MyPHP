...
<form action="" method="post">
	<table>
		...
		<tr>
			...
			<td><input type="text" name="konfirmasi_password"></td>
		</tr>
		<tr>
			<td></td>
...
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href=''>My_QUIZZ</a></div>
            <div class="menu">
                <ul>
...
<form action="" method="post">
	<table>
		<tr>
			<td> jawab</td>
			<td><inout type=text name="jawaban"></td>
		</tr>
		<tr>
			<td></td>
			<td><input type="submit" value="kirim" name="prosees"></td>
		</tr>
	</table>
